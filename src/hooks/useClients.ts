...
export function useClients() {
  ...
  const fetchClients = useCallback(async (filters?: { statusId?: number; archived?: boolean; overdue?: boolean; statusCategory?: string; statusCategories?: string[]; paymentPending?: boolean; paymentOverdue?: boolean; excludeStatusNames?: string[] }) => {
    setLoading(true);
    setError(null);
    try {
