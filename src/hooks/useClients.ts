...
export function useClients() {
  ...
  const fetchClients = useCallback(async (filters?: { statusId?: number; archived?: boolean; overdue?: boolean; statusCategory?: string; paymentOverdue?: boolean; excludeStatusNames?: string[] }) => {
    setLoading(true);
    setError(null);
    try {
