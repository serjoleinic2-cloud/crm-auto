...
CREATE TABLE IF NOT EXISTS orders (
  ...
  vin TEXT,
  vin_received_date TEXT,
  moscow_arrival_date TEXT,
  vin_moscow_confirmed INTEGER NOT NULL DEFAULT 0,
  vin_moscow_confirmed_date TEXT,
  client_notified_moscow INTEGER NOT NULL DEFAULT 0,
  client_notified_moscow_date TEXT,
  payment_date TEXT,
  payment_status TEXT,
...
export const DEFAULT_STATUSES = [
  { name: 'Новый клиент',        color: '#64748b', category: 'lead',     sort_order: 0 },
  { name: 'Думает',              color: '#94a3b8', category: 'lead',     sort_order: 1 },
